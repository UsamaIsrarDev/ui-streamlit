...
st.write("Hello Usama!")
st.title("Usama Israr Khan")
st.text("Just Simple Text")

st.markdown("Markdown Here!")
st.header("This is a Header")
st.subheader("It's subheader")
...
df: pd.DataFrame = pd.DataFrame({ "col1": [1, 2, 3], "col2": ['a', 'b', 'c']})

# st.write(df)
st.table(df)
st.json(df.to_dict())

st.metric("my metrix", 42, 2)
